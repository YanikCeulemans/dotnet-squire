...
local str = autoload("dotnet-squire.nfnl.string")
local fs = autoload("dotnet-squire.nfnl.fs")
local nvim = autoload("dotnet-squire.nfnl.nvim")
local compile = autoload("dotnet-squire.nfnl.compile")
local config = autoload("dotnet-squire.nfnl.config")
local api = autoload("dotnet-squire.nfnl.api")
